...
class LWM_Customoptionsgroup_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
    /**
     * Class constructor
     */
    ...
    {
        parent::__construct();
        $this->setTemplate('customoptionsgroup/catalog/product/edit/options/option.phtml');
        $this->setCanReadPrice(true);
        $this->setCanEditPrice(true);
    }
    public function getGroupOptionsHtml()
    {
        $select = $this->getLayout()->createBlock('adminhtml/html_select')
            ->setData(array(
                'id' => $this->getFieldId().'_{{id}}_group_options',
                'class' => 'select required-option-select'
            ))
            ->setName($this->getFieldName().'[{{id}}][group_options]')
            ->setOptions(Mage::getSingleton('customoptionsgroup/system_groupoptions')->toOptionArray());
...
//        $optionsArr = $this->getProduct()->getOptions();
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
                ...
                $value['group_options'] = $option->getGroupOptions();
